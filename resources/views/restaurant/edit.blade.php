        ...
        <div class="card row mt-5 p-3">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <hr>
                    <div class="row mt-4">
                        <form method="POST" action="{{url("restaurant/$restaurant->restaurant_id/edit")}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <select class="form-control" required id="city_id" name="city_id">
                                        ...
                                        @foreach($cities as $city)
                                            <option {{$restaurant->city_id == $city->city_id ? "selected" : ""}} value="{{$city->city_id}}">{{$city->name}}</option>
                                        @endforeach
                                    </select>
