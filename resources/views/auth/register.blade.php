    ...
    <div>
        <form action="{{url("/register")}}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="first_name" value="Mustafa" id="first_name" placeholder="Enter Firstname" required>
            ...
            <div>
                ...
                <input type="text" name="last_name" value="Guner" placeholder="Enter Lastname" id="last_name" required>
            ...
            <div>
                ...
                <input type="password" name="password" value="asdf1234" placeholder="Enter Password" id="password" required>
                ...
                <label>
                    ...
                    <select name="user_type_id" required>
                        ...
                        @foreach($userTypes as $userType)
                            <option value="{{$userType->user_type_id}}">{{$userType->title}}</option>
                        @endforeach
                    </select>
                </label>
            </div>
            ...
            <div>
                ...
                <input required type="email" name="email" value="test@outlook.com" placeholder="Enter Email" id="email">
                @if ($errors->has('email'))
            ...
            <div>
                ...
                <input required type="text" name="phone_no" value="5338673755"  id="phone_no">
