                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#333333">
                                                                    <p>We are sorry to let you know that your
                                                                        reservation request to <strong>{{$details["restaurant_name"]}}</strong> has been <strong><span class="text-danger">REJECTED</span></strong> by
                                                                        the restaurant owner. Probably the restaurant/cafe is not available during the reservation date/time <strong>({{$details["reservation_date"]}})</strong> you picked.We wish you better luck on your next time reservation request.</p>
